...
for option in MODULES BLOCK MTD USB_SUPPORT MMC SCSI ATA MD BLK_DEV_DM \
    ...
    PACKET UNIX WIRELESS WLAN NET_DSA NET_PTP_CLASSIFY NET_SWITCHDEV \
    NET_RX_BUSY_POLL NET_PKTGEN NET_SELFTESTS NETWORK_FILESYSTEMS \
    IP_PNP NFS_FS ROOT_NFS SUNRPC; do
